...
const Section = () => {
  return (
    <div>
      <div className="mt-20">
        <div className=" inline-block md:flex lg:max-w-full lg:px-32 2xl:px-72  max-w-6xl m-auto  gap-20   p-6 ">
          <div className="min-h-screen md:min-h-screen landing_image p-8 w-full rounded-md">
            ...
            >
              <div className="font-bold pb-3 text-md">
                Due to the evergrowinf presence of the memebter of this
                commision
              </div>
          ...
          <div className="mt-20 " data-aos="fade-left">
            ...
            <div className=" text-xl flex mb-2 items-center align-middle">
              ...
              <div className="text-sm px-3">
                {" "}
                90% Digital Based No Paper Work
              </div>
            </div>
            <div className=" text-xl flex mb-2 items-center align-middle">
              <div className="p-2 rounded-md bg-yellow-200 flex items-center align-middle text-center">
              ...
              <div className="text-sm px-3"> Full Smart Home Equipment</div>
            </div>
          </div>
        </div>
      </div>
