...
const Footer = () => {
  ...
  return (
    <div className="bg-yellow-200 text-gray-200">
      <footer class="bg-yellow-100 dark:bg-gray-900 lg:grid lg:grid-cols-5">
          ...
          <div class="mt-12 border-t border-gray-100 pt-12 dark:border-gray-800">
            <div class="sm:flex sm:items-center sm:justify-between">
              ...
              <p class="mt-8 text-xs text-gray-500 dark:text-gray-400 sm:mt-0">
                &copy; 2024. <span className="text-green-500">Real Estate</span>{" "}
                All rights reserved.
              </p>
            </div>
          </div>
